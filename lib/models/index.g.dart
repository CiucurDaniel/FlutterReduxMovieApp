...
class _$AppState extends AppState {
  ...
  _$AppState._({this.movies, this.page, this.quality, this.sortBy, this.orderBy, this.isLoading, this.genres})
      : super._() {
    if (movies == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc($jc($jc(0, movies.hashCode), page.hashCode), quality.hashCode), sortBy.hashCode),
                orderBy.hashCode),
            isLoading.hashCode),
        genres.hashCode));
  }
